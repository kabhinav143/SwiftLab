...
var favoriteBook=Book(title: "Gulliver Travel", author: "Jonathan Smith", pages: 300, price: 750.00)
...
var laptop2=Laptop(yearPurchased: 2023)
print(laptop1)
print(laptop2)
...
print("My Height in Inches is: \(myHeight.heightInInches) and in Centimeters is: \(myHeight.heightInCentimeters)")
/*:

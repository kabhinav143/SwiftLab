...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser=User(userName: "abc", email: "abc@gmail.com", age: 45)
 ...
 */
let utkarsh = User(userName: "imukohli", email: "uk2003@gmail.com", age: 20)
User.logIn(user: utkarsh)

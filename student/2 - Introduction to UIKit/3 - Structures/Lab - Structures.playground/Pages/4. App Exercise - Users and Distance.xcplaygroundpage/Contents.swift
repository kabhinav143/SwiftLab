...
var mySelf = User(name: "Utkarsh", age: 20, height: 173.0, weight: 85, activityLevel: 7)
print("My Name is: \(mySelf.name). I am \(mySelf.age) years Old. My Height and Weight are: \(mySelf.height) and \(mySelf.weight) respectively. My Activity Level is: \(mySelf.activityLevel)")
/*:
...
var check2 = Distance(feet: 5249.344)
print(check2.meter)
/*:

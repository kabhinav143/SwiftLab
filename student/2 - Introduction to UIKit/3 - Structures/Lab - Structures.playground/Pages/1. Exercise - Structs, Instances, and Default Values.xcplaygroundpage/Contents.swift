...
var somePlace=GPS()
print(somePlace.latitute,somePlace.longitute)
//:  Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
somePlace=GPS(latitute:51.514004,longitute: 0.125226)
print(somePlace.latitute, somePlace.longitute)
...
var favoriteBook=Book(title: "Gulliver Travels", author: "Jonathan Swift",pages:300, price: 750.00)

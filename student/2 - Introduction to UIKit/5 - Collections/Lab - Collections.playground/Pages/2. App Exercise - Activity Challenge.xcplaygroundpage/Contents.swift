 ...
 */
//var exercise:Array<String>=[]
var walk=["Walk 3 miles a day","Hello"]
var run=["Run 5 times a week","World"]
var exercise=[walk,run]
...
var newChallenges:[String]=["Chest","Biceps","Triceps","Back"]
...
if(newChallenges.isEmpty){
    ...
    print("The Challenge you have choosen is \(newChallenges[0])")
}
else{
    print("You have Chosen multiple challenges i.e \(newChallenges)")
}
/*:
